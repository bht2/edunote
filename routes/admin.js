...
// Sub-Admins
router.get('/subadmins',                subAdminController.index);
router.get('/subadmins/create',         subAdminController.create);
router.post('/subadmins',               subAdminController.store);
router.get('/subadmins/:id/edit',       subAdminController.edit);
router.post('/subadmins/:id',           subAdminController.update);
router.post('/subadmins/:id/delete',    subAdminController.destroy);
